...
public class RecordingVoiceView extends FrameLayout {
    ...
    public RecordingVoiceView(Context context, AttributeSet attrs, int defStyleAttr, int
            defStyleRes) {
    ...
    private void initView(Context context) {
        ...
        mRecordingContainer = findViewById(R.id.recording_voice_container);
        mCancelRecordingContainer = findViewById(R.id.cancel_recording_voice_container);
