...
import com.yxl.shishile.shishile.widgets.DragPhotoView;
...
public class DragPhotoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<String> photoList = getIntent().getStringArrayListExtra(Constant.PHOTO_LIST);
        if (photoList != null) {
            mList.clear();
        ...
        for (int i = 0; i < mPhotoViews.length; i++) {
            ...
            Glide.with(DragPhotoActivity.this).load(mList.get(i)).into(mPhotoViews[i]);
    ...
    private void performExitAnimation(final DragPhotoView view, float x, float y, float w, float h) {
        ...
        translateYAnimator.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationStart(Animator animator) {
                mRootLayout.setBackgroundColor(getResources().getColor(android.R.color.transparent));
            }
